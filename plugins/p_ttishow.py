...
async def disable_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('DEVELOERS', url=f'https://t.me/{SUPPORT_CHAT}')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        await bot.send_message(
            chat_id=chat_, 
...
async def ban_a_user(bot, message):
    ...
    try:
        ...
        await message.reply(f"Succesfully banned {k.mention} by @XaynBot")
...
async def unban_a_user(bot, message):
    ...
    try:
        ...
        return await message.reply("Thismight be a channel, make sure it is a user.")
    except Exception as e:
        return await message.reply(f'Error - {e}')
    else:
        jar = await db.get_ban_status(k.id)
        ...
        await message.reply(f"Succesfully unbanned {k.mention} by @XaynBot")
